...
export default function Component() {
  ...
  const [currentPage, setCurrentPage] = useState<"dashboard" | "achievements">("dashboard")
  ...
  const [editingCardData, setEditingCardData] = useState<{ [key: string]: string }>({})
      ...
      achievements.map((a) =>
        a.id === id
          ? {
              ...
              completedDate: !a.completed ? new Date().toISOString().split("T")[0] : undefined,
  ...
  const addAchievement = () => {
    if (newAchievement.title && newAchievement.description) {
      const achievement: Achievement = {
        ...
        progress: newAchievement.type === "goal" ? newAchievement.progress || 0 : undefined,
  ...
  const updateCategoryStats = (categoryId: string, stats: any) => {
    setCategories(categories.map((cat) => (cat.id === categoryId ? { ...cat, stats } : cat)))
  }
  ...
  const getBestValue = (categoryId: string, field: string) => {
    ...
    if (field.includes("pace") || field.includes("weight") || field.includes("bodyFat")) {
      return Math.min(...values.map((v) => Number.parseFloat(v.toString().replace(/[^\d.]/g, ""))))
    }
    // For most other metrics - higher is better
    return Math.max(...values.map((v) => Number.parseFloat(v.toString().replace(/[^\d.]/g, ""))))
  }
  ...
  const getFieldTrend = (categoryId: string, field: string) => {
    ...
    const current = Number.parseFloat(history[0].data[field]?.toString().replace(/[^\d.]/g, "") || "0")
    const previous = Number.parseFloat(history[1].data[field]?.toString().replace(/[^\d.]/g, "") || "0")
  ...
  const userStats = {
    ...
    activeGoals: achievements.filter((a) => a.type === "goal" && !a.completed).length,
  ...
  const editDataCard = (categoryId: string, fields: { [key: string]: string }, title: string) => {
  ...
  const updateDataCard = () => {
    if (editingDataCard && Object.keys(editingCardData).length > 0) {
      ...
      const category = categories.find((c) => c.id === editingDataCard.categoryId)
      if (category) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-3xl font-bold text-gray-900">Achievement Tracker</h2>
          <p className="mt-2 text-sm text-gray-600">Sign in to track your personal achievements</p>
        </div>
        <Card className="mt-8">
          <CardHeader>
      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between bg-white rounded-lg p-6 shadow-sm">
          <div className="flex items-center space-x-4">
            <Button variant="outline" onClick={() => setCurrentPage("dashboard")} className="mr-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Track your accomplishments and long-term objectives</p>
            </div>
          </div>
          <div className="flex items-center space-x-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">{userStats.completedAchievements}</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">{userStats.completedThisMonth}</div>
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Add a new achievement or goal to track your progress</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="achievement">🏆 Achievement (One-time accomplishment)</SelectItem>
                        <SelectItem value="goal">🎯 Goal (Long-term objective with progress)</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
                  ...
                  <div>
                    <Label htmlFor="new-achievement-description">Description</Label>
                    <Textarea
                  ...
                  <div>
                    <Label htmlFor="new-achievement-metric">Target/Metric</Label>
                    <Input
                  ...
                  {newAchievement.type === "goal" && (
                    <>
                      <div>
                        <Label htmlFor="new-achievement-current">Current Status</Label>
                        <Input
                          id="new-achievement-current"
                          value={newAchievement.current || ""}
                          onChange={(e) => setNewAchievement({ ...newAchievement, current: e.target.value })}
                          placeholder="e.g., Can run 10K"
                        />
                      </div>
                      <div>
                        <Label htmlFor="new-achievement-progress">Progress (%)</Label>
                        <Input
                          ...
                          onChange={(e) =>
                            setNewAchievement({ ...newAchievement, progress: Number.parseInt(e.target.value) })
                          }
                        />
                      </div>
                    </>
                ...
                <DialogFooter>
                  ...
                  >
                    Create {newAchievement.type === "goal" ? "Goal" : "Achievement"}
                  </Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex space-x-2">
              {[
                ...
                <Button
                  key={key}
                  variant={selectedAchievementFilter === key ? "default" : "outline"}
                  size="sm"
                ...
                >
                  ...
                  <Badge variant="secondary" className="ml-1">
                    ...
                    {key === "completed" && achievements.filter((a) => a.completed).length}
                    {key === "in-progress" && achievements.filter((a) => !a.completed).length}
                    {key === "goals" && achievements.filter((a) => a.type === "goal").length}
                  </Badge>
                </Button>
              ))}
            </div>
              ...
              >
                ...
                <CardContent className="space-y-4 flex flex-col h-full">
                  ...
                  <div className="space-y-2">
                    ...
                    {isGoal && achievement.current && (
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-medium">{achievement.current}</span>
                      </div>
                    )}
                  ...
                  <div className="pt-2 border-t mt-auto">
                    <Button
                      onClick={() => toggleAchievementCompletion(achievement.id)}
      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between bg-white rounded-lg p-6 shadow-sm">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Personal Achievement Tracker • Member since {userProfile.joinDate}</p>
            </div>
          </div>
          <div className="flex items-center space-x-6">
            <div className="text-center">
            ...
            >
              <div className="text-2xl font-bold text-green-600">{userStats.totalAchievements}</div>
              ...
              <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
                ...
                <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                  <DialogHeader>
                    ...
                    <DialogDescription>Manage your categories, stats, and achievements</DialogDescription>
                  </DialogHeader>
                  <Tabs defaultValue="categories" className="w-full">
                              ...
                              {Object.entries(category.stats).map(([key, value]) => (
                                <div key={key}>
                                  ...
                                  <Input
                                    value={value}
                                    onChange={(e) => {
                                      const newStats = { ...category.stats, [key]: e.target.value }
                                      updateCategoryStats(category.id, newStats)
                                    }}
                                  />
                                </div>
                              ))}
                    ...
                    <TabsContent value="achievements" className="space-y-4">
                      <div className="flex justify-between items-center">
                        <h3 className="text-lg font-semibold">Manage Achievements & Goals</h3>
                      ...
                      <div className="space-y-2">
                        {achievements.slice(0, 5).map((achievement) => (
                          <div key={achievement.id} className="flex items-center justify-between p-3 border rounded-lg">
                            ...
                            <div className="flex space-x-2">
                              <Button variant="outline" size="sm" onClick={() => setEditingAchievement(achievement)}>
                                <Edit className="h-4 w-4" />
                              </Button>
                              <Button
                                variant="outline"
                        ...
                        {achievements.length > 5 && (
                          <div className="text-center pt-2">
                            <Button variant="outline" onClick={() => setCurrentPage("achievements")}>
                    ...
                    <TabsContent value="data" className="space-y-4">
                      <div className="space-y-4">
                        <div>
                          ...
                          <Button
                            onClick={() => {
                              const data = { userProfile, achievements, categories, dataHistory }
        ...
        <Tabs value={selectedCategory} onValueChange={setSelectedCategory} className="space-y-6">
          ...
          <TabsContent value="overview" className="space-y-6">
                ...
                return (
                  <Card
                    ...
                    onClick={() => {
                      ...
                      editDataCard(category.id, keyStats, `${category.name} Overview`)
                    }}
                  >
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          <Badge variant="secondary">{Object.keys(category.stats).length} metrics</Badge>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        {Object.keys(category.stats).length > 3 && (
                          <div className="text-xs text-gray-500 pt-1">
                            +{Object.keys(category.stats).length - 3} more metrics
                          </div>
                        )}
                      </div>
                    </CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Long-term objectives with progress tracking</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {achievements
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600 mb-2">{goal.current}</p>
                            <div className="flex items-center space-x-2">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-right">
                            <div className="font-bold text-green-600">{achievement.metric}</div>
                          </div>
                        </div>
                      )
                    })}
          ...
          <TabsContent value="fitness" className="space-y-6">
            {/* Fitness Stats Cards */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(categories.find((c) => c.id === "fitness")?.stats || {}).map(([key, value]) => {
                ...
                return (
                  <Card
                    ...
                    onClick={() =>
                      editDataCard("fitness", { [key]: value }, `Update ${key.replace(/([A-Z])/g, " $1")}`)
                    }
                  >
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between">
            ...
            <Card>
              ...
              <CardContent>
                <Button onClick={() => setAddingDataFor("fitness")} className="w-full">
                  <Plus className="h-4 w-4 mr-2" />
          ...
          <TabsContent value="finances" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(categories.find((c) => c.id === "finances")?.stats || {}).map(([key, value]) => {
                ...
                return (
                  <Card
                    ...
                    onClick={() =>
                      editDataCard("finances", { [key]: value }, `Update ${key.replace(/([A-Z])/g, " $1")}`)
                    }
                  >
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between">
                    ...
                    <CardContent>
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        {key.includes("netWorth") && "Total assets minus liabilities"}
                        {key.includes("income") && "Monthly gross income"}
                        {key.includes("savings") && "Money saved this period"}
                        {key.includes("investment") && "Investment portfolio value"}
            ...
            <Card>
              ...
              <CardContent>
                <Button onClick={() => setAddingDataFor("finances")} className="w-full">
                  <Plus className="h-4 w-4 mr-2" />
          ...
          <TabsContent value="learning" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(categories.find((c) => c.id === "learning")?.stats || {}).map(([key, value]) => {
                ...
                return (
                  <Card
                    ...
                    className="cursor-pointer hover:shadow-lg transition-all duration-200 hover:border-blue-300"
                    onClick={() =>
                      editDataCard("learning", { [key]: value }, `Update ${key.replace(/([A-Z])/g, " $1")}`)
                    }
                  >
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between">
            ...
            <Card>
              ...
              <CardContent>
                <Button onClick={() => setAddingDataFor("learning")} className="w-full">
                  <Plus className="h-4 w-4 mr-2" />
          ...
          <TabsContent value="career" className="space-y-6">
            {/* Career Stats Cards */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {Object.entries(categories.find((c) => c.id === "career")?.stats || {}).map(([key, value]) => {
                ...
                return (
                  <Card
                    ...
                    onClick={() => editDataCard("career", { [key]: value }, `Update ${key.replace(/([A-Z])/g, " $1")}`)}
                  >
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between">
            ...
            <Card>
              ...
              <CardContent>
                <Button onClick={() => setAddingDataFor("career")} className="w-full">
                  <Plus className="h-4 w-4 mr-2" />
        ...
        <>
          ...
          {editingAchievement && (
            <Dialog open={!!editingAchievement} onOpenChange={() => setEditingAchievement(null)}>
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Edit {editingAchievement.type === "goal" ? "Goal" : "Achievement"}</DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  <div>
                  ...
                  <div>
                    <Label htmlFor="edit-achievement-metric">Target/Metric</Label>
                    <Input
                      id="edit-achievement-metric"
                      value={editingAchievement.metric}
                      onChange={(e) => setEditingAchievement({ ...editingAchievement, metric: e.target.value })}
                    />
                  </div>
                  <div>
                  ...
                  {editingAchievement.type === "goal" && (
                    <>
                      <div>
                        <Label htmlFor="edit-achievement-current">Current Status</Label>
                        <Input
                          id="edit-achievement-current"
                          value={editingAchievement.current || ""}
                          onChange={(e) => setEditingAchievement({ ...editingAchievement, current: e.target.value })}
                        />
                      </div>
                      <div>
                        <Label htmlFor="edit-achievement-progress">Progress (%)</Label>
                        <Input
                          ...
                          onChange={(e) =>
                            setEditingAchievement({ ...editingAchievement, progress: Number.parseInt(e.target.value) })
                          }
                        />
                      </div>
                    </>
                ...
                <DialogFooter>
                  ...
                  <Button onClick={() => updateAchievement(editingAchievement)}>Save Changes</Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
          )}
          ...
          {addingDataFor && (
            <Dialog open={!!addingDataFor} onOpenChange={() => setAddingDataFor(null)}>
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Add New {categories.find((c) => c.id === addingDataFor)?.name} Entry</DialogTitle>
                  <DialogDescription>Enter new data for this category</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  {Object.keys(categories.find((c) => c.id === addingDataFor)?.stats || {})
                    .slice(0, 6)
                    .map((key) => (
                      <div key={key}>
                        ...
                        <Input
                          ...
                          onChange={(e) => setNewDataEntry({ ...newDataEntry, [key]: e.target.value })}
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setNewDataEntry({ ...newDataEntry, note: e.target.value })}
                ...
                <DialogFooter>
                  ...
                  <Button onClick={() => addDataEntry(addingDataFor!)}>Add Entry</Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
          )}
          ...
          {editingDataCard && (
            <Dialog open={!!editingDataCard} onOpenChange={() => setEditingDataCard(null)}>
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Update {editingDataCard.title}</DialogTitle>
                  <DialogDescription>Edit the values for this data group</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  {Object.entries(editingCardData).map(([key, value]) => (
                    <div key={key}>
                      ...
                      <Input
                        id={key}
                        value={value}
                        onChange={(e) => setEditingCardData({ ...editingCardData, [key]: e.target.value })}
                ...
                <DialogFooter>
                  <Button variant="outline" onClick={() => setEditingDataCard(null)}>
                    Cancel
                  </Button>
